...
public class ThiSinhB extends ThiSinh {
    private final String khoi319 = "B";
    private final String mon319 = "Toan, Hoa, Sinh";

    public ThiSinhB(String soBD319, String hoTen319, String diaChi319, String uuTien319) {
